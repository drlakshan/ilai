...
columns:
  ...
  Tags:
    ...
    options:
      ...
      - { label: "Panel Discussion", value: "Panel Discussion", color: "hsl(135, 95%, 90%)"}
      - { label: "Medical Education", value: "Medical Education", color: "hsl(104, 95%, 90%)"}
      - { label: "Symposium", value: "Symposium", color: "hsl(77, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
  ...
  URL:
    ...
    options:
      ...
      - { label: "https://drive.google.com/drive/folders/1-Z8JU92YTh0FeB4Erul2GguZU2BLtjyC?usp=drive_link", value: "https://drive.google.com/drive/folders/1-Z8JU92YTh0FeB4Erul2GguZU2BLtjyC?usp=drive_link", color: "hsl(47, 95%, 90%)"}
      - { label: "https://docs.google.com/presentation/d/1hbY453YUYvVIeHg0FzzmpffbH3lVSZ3cw5GVf2L2We8/edit#slide=id.p", value: "https://docs.google.com/presentation/d/1hbY453YUYvVIeHg0FzzmpffbH3lVSZ3cw5GVf2L2We8/edit#slide=id.p", color: "hsl(107, 95%, 90%)"}
      - { label: "https://docs.google.com/presentation/d/1R43bRTHDyD2aQl-R_bMd4RtjFnDEOESP2cCxnrmaq-s/edit?usp=drivesdk", value: "https://docs.google.com/presentation/d/1R43bRTHDyD2aQl-R_bMd4RtjFnDEOESP2cCxnrmaq-s/edit?usp=drivesdk", color: "hsl(152, 95%, 90%)"}
    config:
      enable_media_view: true
      link_alias_enabled: true
      media_width: 100
