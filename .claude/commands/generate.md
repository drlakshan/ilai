# .claude/commands/generate.toml
#
# Usage: /canvas-generate [note-name]
# Example: /canvas-generate "Complex ENT Concepts"
#

[command]
id = "canvas-generate"
label = "Canvas Generator"
description = "Generate a visual canvas for notes mentioned"
...
user = """
NOTE TO PROCESS: {{note_name}}

VAULT CONTEXT:
{{context}}

Create a comprehensive JSON Canvas visualization for the specified note, incorporating Dr. Lakshan's medical expertise and knowledge management principles.
"""
